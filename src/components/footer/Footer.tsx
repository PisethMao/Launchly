            ...
            >
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8">
                    ...
                    <motion.div variants={itemVariants} className="lg:col-span-4">
                        ...
                        <p className="text-gray-600 dark:text-gray-300 leading-relaxed max-w-sm mb-6">
                            Deploy websites automatically from GitHub and GitLab with SSL & domains in seconds.
                        </p>

                        {/* Social Links */}
                        <div className="flex items-center gap-3">
                            {[
                                { href: "https://github.com/PisethMao", icon: "github", label: "GitHub" },
                                { href: "https://discord.com/channels/@me", icon: "discord", label: "Discord" },
                                { href: "https://x.com/PisethMao528763", icon: "twitter", label: "Twitter" }
                            ].map((social) => (
                                <Link
                                    key={social.icon}
                                    href={social.href}
                ...
                >
                    ...
                    <div className="flex items-center gap-6 text-sm">
                        <span className="text-gray-500 dark:text-gray-500">Made with ❤️ in Cambodia</span>
