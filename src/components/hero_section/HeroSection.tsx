...
export default function HeroSection() {
  ...
  return (
    <section className="pt-20 md:pt-28 cursor-pointer font-poppins relative overflow-hidden bg-linear-to-br from-slate-50 via-blue-50 to-indigo-100 dark:from-gray-950 dark:via-gray-900 dark:to-indigo-950">
      <div className="max-w-7xl mx-auto flex flex-col-reverse md:flex-row items-center justify-between gap-10 min-h-[calc(100vh-80px)] px-6 md:px-20 pb-16 md:pb-24">
        <motion.div
        ...
        >
          ...
          <p className="text-lg md:text-xl text-gray-600 dark:text-gray-300 max-w-xl mx-auto md:mx-0 mb-8 leading-relaxed">
            Experience lightning-fast deployments with automatic SSL, custom
            domains, and zero configuration. Your projects live in seconds.
          </p>
        ...
        >
          <motion.div animate={floatingAnimation} className="relative group">
              ...
              <div className="p-6 space-y-4">
                ...
                {[
                  ...
                  >
                    ...
                    <div
                      className={`px-3 py-1 bg-${item.color}-100 dark:bg-${item.color}-900/30 text-${item.color}-700 dark:text-${item.color}-400 rounded-full text-xs font-medium`}
                    >
                      {item.status}
                    </div>
                  </motion.div>
        ...
        <div className="absolute inset-0 -z-10">
          ...
          <div
            className="absolute bottom-20 left-10 w-80 h-80 bg-purple-400/20 rounded-full blur-3xl animate-pulse"
            style={{ animationDelay: "1s" }}
          ></div>
          <div
            className="absolute top-1/2 left-1/2 w-72 h-72 bg-pink-400/10 rounded-full blur-3xl animate-pulse"
