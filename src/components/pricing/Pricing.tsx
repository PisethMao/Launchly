...
function PlanCard({ plan, isYearly }: { plan: Plan; isYearly: boolean }) {
    ...
    const savings = plan.price !== "Custom" && plan.yearlyPrice && plan.yearlyPrice !== plan.price;
            ...
            <div className="mx-auto max-w-7xl">
                <div className="mx-auto max-w-3xl text-center">
                    ...
                    <p className="mt-6 text-lg leading-relaxed text-gray-600 dark:text-gray-300">
                        Deploy websites effortlessly with one-click automatic deployments, SSL, and domains built in.
                        <span className="font-semibold text-indigo-600 dark:text-indigo-400"> Pick a plan that grows with you.</span>
                    </p>
                </div>
                    ...
                    {[
                        {
                            ...
                            description: "Certificates are always valid—no manual renewal or maintenance."
                        },
                        {
                            icon: (
                                <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            description: "Push code → Launchly builds and deploys in isolated environments."
                        },
                        {
                            icon: (
                                <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            description: "Transparent build logs and environment isolation for every deploy."
                        }
                    ].map((item, i) => (
                        <div
                            key={i}
