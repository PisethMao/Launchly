...
const DeploymentDocsPage = () => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-purple-50/30 dark:from-gray-950 dark:via-blue-950/20 dark:to-purple-950/20 transition-colors duration-300">
            {/* Floating Orbs */}
            ...
            <div className="fixed bottom-20 right-10 w-96 h-96 bg-purple-500/10 dark:bg-purple-500/5 rounded-full blur-3xl animate-pulse pointer-events-none" style={{ animationDelay: '1s' }} />
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
                    <motion.div {...fadeInUp} className="text-center">
                        ...
                        <p className="text-xl max-w-3xl mx-auto text-gray-600 dark:text-gray-300 leading-relaxed">
                            Multiple deployment options to fit your workflow. Choose the method that works best for you.
                        </p>
                        ...
                        <div className="mt-12 grid grid-cols-3 gap-8 max-w-2xl mx-auto">
                            {[
                                ...
                                <div key={i} className="text-center">
                                    <div className="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-gradient-to-br from-blue-500 to-purple-500 text-white mb-3">
            ...
            <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                ...
                >
                    ...
                    >
                        <div className="relative bg-gradient-to-r from-gray-800 via-gray-900 to-black px-8 py-8 overflow-hidden">
                        ...
                        <div className="p-8">
                            <div className="prose max-w-none">
                                <p className="text-lg mb-8 text-gray-700 dark:text-gray-300">
                                    Deploy your static website by connecting your public GitHub/GitLab repository directly. Perfect for simple projects and quick deployments.
                                </p>
...
└── pages/
    ...
    └── contact.html`}
                                    ...
                                    <div className="flex gap-4">
                                        ...
                                        <div className="flex-1">
                                            ...
                                            <ul className="space-y-2 text-amber-800 dark:text-amber-200">
                                                ...
                                                <li className="flex items-start gap-2">
                                                    <span className="text-amber-600 dark:text-amber-400 mt-0.5">•</span>
                                                    <span>Only static files (HTML, CSS, JavaScript, images, fonts)</span>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                    ...
                    >
                        ...
                        <div className="p-8">
                            <p className="text-lg mb-8 text-gray-700 dark:text-gray-300">
                                Connect your GitHub account and deploy directly from your private repositories with personal access tokens.
                            </p>
                            ...
                            <div className="space-y-5">
                                {[
                                    ...
                                    <div key={idx} className="flex gap-5 items-start p-5 rounded-xl bg-gray-50 dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 hover:border-gray-300 dark:hover:border-gray-600 transition-colors">
                                        <div className="flex-shrink-0 w-10 h-10 bg-gradient-to-br from-gray-700 to-gray-900 text-white rounded-xl flex items-center justify-center font-bold text-lg shadow-lg">
                                            {idx + 1}
                                        </div>
                            ...
                            <div className="mt-8 rounded-2xl p-5 bg-blue-50 dark:bg-blue-900/20 border-2 border-blue-200 dark:border-blue-700/50 flex items-start gap-3">
                                ...
                                <p className="text-blue-900 dark:text-blue-300">
                                    Your token is encrypted and stored securely. We only use it to access the repositories you authorize.
                                </p>
                            </div>
                        </div>
                    </motion.div>
                    ...
                    <motion.div
                        ...
                        className="group rounded-3xl shadow-xl overflow-hidden border border-gray-200 dark:border-gray-700 bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl transition-all duration-300 hover:shadow-2xl"
                    >
                        <div className="relative bg-gradient-to-r from-orange-500 via-red-500 to-pink-500 px-8 py-8 overflow-hidden">
                        ...
                        <div className="p-8">
                            <p className="text-lg mb-8 text-gray-700 dark:text-gray-300">
                                Connect your GitLab account and deploy directly from your private repositories with personal access tokens.
                            </p>
                            ...
                            <div className="space-y-5">
                                {[
                                    ...
                                    <div key={idx} className="flex gap-5 items-start p-5 rounded-xl bg-orange-50 dark:bg-orange-900/10 border border-orange-200 dark:border-orange-700/30 hover:border-orange-300 dark:hover:border-orange-600/50 transition-colors">
                                        <div className="flex-shrink-0 w-10 h-10 bg-gradient-to-br from-orange-500 to-red-500 text-white rounded-xl flex items-center justify-center font-bold text-lg shadow-lg">
                                            {idx + 1}
                                        </div>
                                        <div className="flex-1 pt-0.5">
                                            <p className="font-bold text-gray-900 dark:text-white mb-1 text-lg">
                    ...
                    <motion.div
                        ...
                        className="group rounded-3xl shadow-xl overflow-hidden border border-gray-200 dark:border-gray-700 bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl transition-all duration-300 hover:shadow-2xl"
                    >
                        <div className="relative bg-gradient-to-r from-emerald-500 via-teal-500 to-cyan-500 px-8 py-8 overflow-hidden">
                            <div className="absolute top-0 right-0 w-64 h-64 bg-white/10 rounded-full blur-3xl" />
                            <div className="relative flex items-center gap-4">
                                <div className="bg-white/20 backdrop-blur-sm p-4 rounded-xl group-hover:scale-110 transition-transform duration-300">
                        ...
                        <div className="p-8">
                            <p className="text-lg mb-8 text-gray-700 dark:text-gray-300">
                                Package your entire project into a ZIP file and upload it all at once. Quick and convenient for projects with many files.
                            </p>
        ...
        └── images/`}
                            ...
                            <div className="grid md:grid-cols-2 gap-5">
                                ...
                                <div className="rounded-2xl p-6 bg-red-50 dark:bg-red-900/20 border-2 border-red-200 dark:border-red-700/50">
                                    <div className="flex items-center gap-2 mb-4">
                                        <div className="w-8 h-8 rounded-lg bg-red-500 flex items-center justify-center text-white font-bold">✗</div>
                    ...
                    >
                        ...
                        <div className="relative p-12 text-center text-white">
                            ...
                            <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto leading-relaxed">
                                Choose any method above and get your project live in seconds. No complex configuration required.
                            </p>
