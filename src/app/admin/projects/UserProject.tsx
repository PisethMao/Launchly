    ...
    return (
        <div className="space-y-6">
            <div className="animate-fade-in">
                <h1 className="text-5xl font-black text-gray-900 dark:text-white mb-2 bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent">
                    Projects Management
                </h1>
                            ...
                            {filteredProjects.map((p, idx) => (
                                <tr
                                    ...
                                    className={`transition-all duration-300 ${
                                        hoveredRow === p.id
                                            ? "bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-950 dark:to-purple-950 scale-[1.02] shadow-lg"
