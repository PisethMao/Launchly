...
import { Rocket, CreditCard, LogOut, Activity, TrendingUp, CheckCircle2, Loader2, ExternalLink, Settings, FileText } from "lucide-react";
...
export default function page() {
    ...
    return (
        <main className="font-poppins min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/40 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950">
            <div className="max-w-7xl mx-auto px-6 py-40">
                    ...
                    <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8">
                        <div className="space-y-2">
                            ...
                            <div className="flex items-center gap-2 text-sm">
                                <div className="px-3 py-1.5 rounded-full bg-gradient-to-r from-indigo-500/10 to-purple-500/10 border border-indigo-200/50 dark:border-indigo-500/30">
                                    <span className="text-gray-600 dark:text-gray-300">
                                        Current Plan: <span className="font-semibold text-indigo-600 dark:text-indigo-400">{session?.user?.plan}</span>
                                    </span>
                                </div>
                            </div>
                        </div>
                        <div className="flex flex-wrap gap-3">
                            <Link
                                href="/deploy/new"
                                className="group px-6 py-3 rounded-xl bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-medium hover:from-indigo-700 hover:to-purple-700 transition-all shadow-lg shadow-indigo-500/30 hover:shadow-xl hover:shadow-indigo-500/40 active:scale-95 flex items-center gap-2"
                            >
                ...
                >
                    <motion.div
                        ...
                        className="group relative p-6 rounded-2xl bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 p-6 shadow-lg hover:shadow-2xl hover:border-indigo-300 dark:hover:border-indigo-60 transition-all overflow-hidden"
                    >
                        ...
                        <div className="relative flex items-start justify-between">
                            <div>
                                <p className="text-black dark:text-white text-sm font-medium mb-2">Total Deployments</p>
                                <h3 className="text-4xl dark:text-white font-bold">{deployments.length}</h3>
                            </div>
                            <div className="p-3 rounded-xl backdrop-blur-sm bg-gradient-to-br from-blue-500/20 to-indigo-600/20">
                    ...
                    >
                        ...
                        <div className="relative flex items-start justify-between">
                            <div>
                                <p className="dark:text-white text-black text-sm font-medium mb-2">Active Builds</p>
                                <h3 className="dark:text-white text-4xl font-bold">
                                    {deployments.filter((d) => d.status === "Building").length}
                                </h3>
                            </div>
                            <div className="p-3 rounded-xl bg-gradient-to-br from-amber-500/20 to-orange-600/20 backdrop-blur-sm">
                    ...
                    >
                        ...
                        <div className="relative flex items-start justify-between">
                            <div>
                                <p className="dark:text-white text-black text-sm font-medium mb-2">Healthy Sites</p>
                                <h3 className="dark:text-white text-4xl font-bold">
                                    {deployments.filter((d) => d.status === "Healthy").length}
                                </h3>
                            </div>
                            <div className="p-3 rounded-xl backdrop-blur-sm bg-gradient-to-br from-emerald-500/20 to-green-600/20">
                ...
                >
                    <div className="flex items-center gap-3">
                        ...
                        <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Your Deployments</h2>
                    </div>
